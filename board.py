...
class Board(tk.Frame):
    ...
    def __init__(self, parent, Game):
        ...
        self.config = Game.config #battleship
    ...
    def create_mainframe(self):
        self.mainframe = tk.Frame(self, height=self.config.side, width=self.config.side,bg="navy")
        self.mainframe.pack(expand=True)
 
    def create_board(self):
        self.frame_rows = [] #[0, 1, 2, 3, 4]
        color = 756867 #hexadecimal_code
    ...
    def create_button_board(self):
        ...
        for i in range(n_row):
            ...
            for j in range(n_column):
                button = tk.Button(self.frame_rows[i], bg="LightSkyBlue1", image=self.init_img_btn, 
